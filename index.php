...
<body background="Asset\Img\satu.jpg">
<header>
	<div class="wrapper"> 
		<div class="row">
			<div class="col-8"></div> 
...
<br>
<center>
	<font face="Courier New" color="black" size="20"> SELAMAT DATANG <center>
	<font face="Courier New" color="black" size="3"> Think different <center>
	<a href="detail.php" type="submit" class="btn btn-primary" >MULAI</a>
</center> 
<div class="wrapper">
	<div class="row">
</div>
